...
wandb.init(
    project="Logistic Regression Distance Angle",
    config={
...
# Features (distance, angle) and target (goal or not)
X = play_by_play[["shotDistance", "shotAngle"]]
...
wandb.log_model(path=Path(__file__),name="Logistic_regression_dist_angle")
